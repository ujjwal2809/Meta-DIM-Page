...
const SuccessShowcase = () => {
  const successStories = [
    ...
    { name: "Amit Kumar", image: "/assets/images/testimonials/Amit_Kumar.jpeg", companyLogo: "https://logo.clearbit.com/google.com" },
    { name: "Sneha Singh", image: "/assets/images/testimonials/Sneha_Singh.jpeg", companyLogo: "https://logo.clearbit.com/techmahindra.com" },
    { name: "Neha Agrawal", image: "/assets/images/testimonials/Neha_Agarwa.jpeg", companyLogo: "https://logo.clearbit.com/tcs.com" },
    { name: "Shriharsh Gaikwad", image: "/assets/images/testimonials/Shriharsh_Gaikwad.png", companyLogo: "/assets/images/testimonials/Engagely-Logo.png" },
    { name: "Saad Shaikh", image: "/assets/images/testimonials/Saad_Shaikh.png", companyLogo: "/assets/images/testimonials/62fe2830964fbb752b905466_REVSURE-logo-V1-transparent.png" },
    { name: "Anushka Gaikwad", image: "/assets/images/testimonials/Anushka_Gaikwad.png", companyLogo: "/assets/images/testimonials/images.png" },
    { name: "Ganesh Chaudhary", image: "/assets/images/testimonials/Ganesh_Chaudhary.png", companyLogo: "https://logo.clearbit.com/ironmountain.com" },
